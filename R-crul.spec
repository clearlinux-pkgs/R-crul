...
Version  : 1.0.0
Release  : 26
URL      : https://cran.r-project.org/src/contrib/crul_1.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/crul_1.0.0.tar.gz
Summary  : HTTP Client
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596152904
